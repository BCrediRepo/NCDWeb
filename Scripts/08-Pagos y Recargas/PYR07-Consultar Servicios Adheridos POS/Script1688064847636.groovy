...
WebUI.verifyElementVisible(findTestObject('Object Repository/08-Pagos y Recargas/txtNombreServicioAdherido', FailureHandling.CONTINUE_ON_FAILURE))
WebUI.verifyElementVisible(findTestObject('Object Repository/08-Pagos y Recargas/txtNumeroServicioAdherido', FailureHandling.CONTINUE_ON_FAILURE))
...
void fTakeFailScreenshot() {
	CustomKeywords.'pkgUtilities.kwyUtility.fFailStatus'('Screenshot/Fails/PYR07-ConsultarServiciosAdheridosPOS.png')
}
