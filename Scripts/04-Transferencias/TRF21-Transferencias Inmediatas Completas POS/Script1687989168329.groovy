...
vSaldoFinal = WebUI.getText(findTestObject('Object Repository/04-Transferencias/txtTrfSaldoInicial'), vSaldoF)
...
if (vSaldoFinal > vSaldoInicial) {
  ...
  System.out.println("El valor del Saldo se ha restado.")
} else {
...
void fTakeFailScreenshot() {
	CustomKeywords.'pkgUtilities.kwyUtility.fFailStatus'('Screenshot/Fails/TRF21-TransferenciaInmediataCompletaPOS.png')
}
