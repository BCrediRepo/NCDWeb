...
def vQuery1 = "SELECT * FROM Parametros WHERE Nombre = 'BeneficiarioCuentaDolares'"
...
//Busca un Beneficiario con cuenta en Dólares
WebUI.setText(findTestObject('Object Repository/04-Transferencias/03-Nuevo Beneficiario/txtTrxBuscarBeneficiarioTipo'), vBenfTrf, FailureHandling.CONTINUE_ON_FAILURE)

//Selecciona el beneficiario e inicia la transferencia
WebUI.delay(5)
WebUI.click(findTestObject('Object Repository/04-Transferencias/txtTrxBenfCuentaDolar'))
WebUI.click(findTestObject('Object Repository/04-Transferencias/lnkTrxIniciarTrxBenefDolar'))
...
//CustomKeywords.'pkgUtilities.kwyUtility.comparacionDatosExitoPosdatadaDolares'(60)
