...
vlblSinOperacion = vResult2.getString(3)
...
void fTakeFailScreenshot() {
	CustomKeywords.'pkgUtilities.kwyUtility.fFailStatus'('Screenshot/Fails/OPR03-ConsultarOperacionesSinDatosNEG.png')
}
